IMAGENET_PATH='/root/autodl-tmp/JEPAT-imagenet/dataset/imagenet100/image'
...
# --evaluate
# --resume checkpoints/JEPAT_base.pth

# If you want to use cached data, add the following arguments.
--use_cached 
--cached_path /root/autodl-tmp/JEPAT-imagenet/dataset/imagenet100/cache
