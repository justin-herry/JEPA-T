# Modified from https://github.com/Alpha-VLLM/Lumina-T2X/blob/main/lumina_next_t2i_mini/transport.py
...
try:
    ...
    warnings.warn("flow match requires `pip install torchdiffeq==0.2.4`")
...
def training_losses(model, x1: th.Tensor, model_kwargs=None):
